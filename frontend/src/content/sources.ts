...
export const SOURCES: SourceRow[] = [
  {
    ...
    role: { en: 'The yearly frames from 2017, the live scene reads in the browser, the dense series, the training tiles', es: 'Los frames anuales desde 2017, las lecturas en vivo en el navegador, la serie densa, las teselas de entrenamiento' },
    access: { en: 'Earth Search v1 STAC (collection sentinel-2-l2a) and the sentinel-cogs bucket on AWS Open Data, free, not requester-pays', es: 'STAC Earth Search v1 (colección sentinel-2-l2a) y el bucket sentinel-cogs en AWS Open Data, gratuito, sin cobro al solicitante' },
    browser: 'yes',
  ...
  },
  {
    ...
    role: { en: 'The yearly frames 1985 to 2016 (Landsat 5, 7, 8 and 9)', es: 'Los frames anuales de 1985 a 2016 (Landsat 5, 7, 8 y 9)' },
  ...
  },
  {
    ...
    role: { en: 'The 3D relief and hillshade of the globe, the global epoch of the profile tool', es: 'El relieve 3D y el sombreado del globo, la época global de la herramienta de perfil' },
    ...
    browser: 'yes',
    licence: { en: 'Attribution "Mapzen" plus the regional credits (SRTM, GMTED2010, ETOPO1, 3DEP, Geoscience Australia CC BY 4.0, EU-DEM, CDEM, LINZ). In South America the surface is the year-2000 SRTM', es: 'Atribución "Mapzen" más los créditos regionales (SRTM, GMTED2010, ETOPO1, 3DEP, Geoscience Australia CC BY 4.0, EU-DEM, CDEM, LINZ). En Sudamérica la superficie es el SRTM del año 2000' },
  },
  {
    id: 'copdem',
    group: 'elevation',
    ...
    role: { en: 'The later epoch of the elevation difference and the per-site terrain tiles', es: 'La época posterior de la diferencia de elevación y las teselas de terreno por sitio' },
    ...
    browser: 'no',
    licence: { en: 'Copernicus DEM licence: free with attribution to DLR and Airbus under COPERNICUS by the European Union and ESA; absolute vertical accuracy under 4 m at 90%', es: 'Licencia del DEM Copernicus: libre con atribución a DLR y Airbus bajo COPERNICUS por la Unión Europea y ESA; exactitud vertical absoluta bajo 4 m al 90%' },
  },
  {
    id: 'srtm',
    group: 'elevation',
    ...
    role: { en: 'The earlier epoch of the elevation difference', es: 'La época anterior de la diferencia de elevación' },
  ...
  },
  {
    ...
    role: { en: 'The reference polygons of every site: catalog validation, the envelope of the series, the SAM endmember', es: 'Los polígonos de referencia de cada sitio: validación del catálogo, la envolvente de las series, el endmember SAM' },
    access: { en: '44,929 polygons, 101,583 km2, digitised on the 2019 Sentinel-2 cloudless mosaic; overall accuracy 88.3%, F1 0.87', es: '44.929 polígonos, 101.583 km2, digitalizados sobre el mosaico Sentinel-2 sin nubes de 2019; exactitud global 88,3%, F1 0,87' },
    browser: 'partial',
    licence: { en: 'CC BY-SA 4.0 (share-alike: the per-site polygon layers Rajo publishes stay CC BY-SA 4.0)', es: 'CC BY-SA 4.0 (share-alike: las capas de polígonos por sitio que Rajo publica siguen CC BY-SA 4.0)' },
  },
  {
    id: 'tang',
    group: 'footprints',
  ...
  },
  {
    ...
    role: { en: 'The training, validation and test tiles of the learned models (1,514 tiles over 1,210 sites; mine type and scale; a site-level split)', es: 'Las teselas de entrenamiento, validación y prueba de los modelos aprendidos (1.514 teselas sobre 1.210 sitios; tipo y escala; partición por sitio)' },
    access: { en: 'A 35.6 MB GeoPackage with geometry, product ids and the split; the pixels are fetched from Earth Search by product id', es: 'Un GeoPackage de 35,6 MB con geometría, ids de producto y la partición; los píxeles se traen de Earth Search por id de producto' },
    browser: 'no',
  ...
  },
  {
    ...
    url: 'https://s2maps.eu',
    role: { en: 'The imagery basemap of the globe (the 2024 mosaic)', es: 'El mapa base de imágenes del globo (el mosaico 2024)' },
    ...
    browser: 'yes',
    licence: { en: 'CC BY-NC-SA 4.0 for non-commercial use, attribution verbatim: "Sentinel-2 cloudless - https://s2maps.eu by EOX IT Services GmbH (Contains modified Copernicus Sentinel data 2024)"', es: 'CC BY-NC-SA 4.0 para uso no comercial, atribución textual: "Sentinel-2 cloudless - https://s2maps.eu by EOX IT Services GmbH (Contains modified Copernicus Sentinel data 2024)"' },
  },
  {
    id: 'ofm',
    group: 'basemaps',
    ...
    role: { en: 'The place labels and boundaries', es: 'Las etiquetas de lugares y los límites' },
    access: { en: 'tiles.openfreemap.org, no key, no request limits', es: 'tiles.openfreemap.org, sin clave, sin límites de peticiones' },
    browser: 'yes',
    licence: { en: 'Attribution "OpenFreeMap (c) OpenMapTiles Data from OpenStreetMap"', es: 'Atribución "OpenFreeMap (c) OpenMapTiles Data from OpenStreetMap"' },
  },
  ...
  },
  {
    ...
    role: { en: 'Fine copper per operation for 2024 and 2025 and the first year with reported production on the eleven Chilean copper cards (Los Bronces is reported inside Anglo American Sur)', es: 'Cobre fino por operación para 2024 y 2025 y el primer año con producción reportada en las once fichas chilenas de cobre (Los Bronces se reporta dentro de Anglo American Sur)' },
    access: { en: 'XLSX download, unit "Miles TM" (thousand metric tons)', es: 'Descarga XLSX, unidad "Miles TM" (miles de toneladas métricas)' },
    browser: 'no',
    licence: { en: 'Chilean government statistics, cite Cochilco', es: 'Estadísticas del gobierno de Chile, citar Cochilco' },
  },
  {
