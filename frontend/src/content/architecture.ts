  ...
  },
  {
    ...
    body: {
      ...
      es: [
        ...
        'Offline (la cocina, un venv Python 3.12, scripts planos por ruta): la etapa catalog valida los sitios y recorta los polígonos de referencia; scenes busca en Earth Search y el Planetary Computer por sitio y año; frames reproyecta las bandas a la grilla (rasterio WarpedVRT), compone los vacíos de Landsat 7, renderiza frames WebP y guarda los chips; masks evalúa cada frame con Otsu, el bosque y la U-Net dentro de la envolvente; series construye la serie de área minada y sus puntos de cambio; dense lee cada fecha Sentinel-2 despejada desde 2017 a 60 m; dem diferencia SRTM y el DEM Copernicus y cocina las teselas de terreno; export escribe los manifiestos y validate rechaza un hueco.',
