...
// SharedArrayBuffer). The U-Net runs 512 x 512 windows with overlap-tile blending, mirroring
// data-pipeline/train/unet_model.py (predict_tile). The random forest does not run here: the web
// runtime ships no TreeEnsembleClassifier kernel, so forest.ts traverses the flat-array export.
